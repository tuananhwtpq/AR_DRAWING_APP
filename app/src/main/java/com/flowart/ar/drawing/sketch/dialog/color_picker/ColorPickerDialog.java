package com.flowart.ar.drawing.sketch.dialog.color_picker;
...
public class ColorPickerDialog {
    ...
    public ColorPickerDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
        ...
        viewCursor.setBackgroundColor(getColor());
        viewTarget.setBackgroundColor(getColor());
        ...
        if (dialog.getWindow() != null) {
            Window dlWindow = dialog.getWindow();
            dlWindow.setLayout(
                    ViewGroup.LayoutParams.MATCH_PARENT,
                    ViewGroup.LayoutParams.WRAP_CONTENT
            );
            WindowManager.LayoutParams wlp = dlWindow.getAttributes();
            wlp.gravity = Gravity.CENTER;
            dlWindow.setAttributes(wlp);

            dlWindow.setBackgroundDrawableResource(R.drawable.bg_dialog);
        }


        Objects.requireNonNull(dialog.getWindow()).setBackgroundDrawableResource(R.drawable.bg_dialog);
    ...
    protected void moveCursor() {
        ...
        int cursorWidth = viewCursor.getMeasuredWidth();
        int cursorHeight = viewCursor.getMeasuredHeight();

        // Set the cursor position without margins
        layoutParams.leftMargin = viewHue.getLeft() + (viewHue.getMeasuredWidth() - cursorWidth) / 2;
        layoutParams.topMargin = (int) (viewHue.getTop() + y - Math.floor((double) cursorHeight / 2));
    ...
    protected void moveTarget() {
        ...
        layoutParams.leftMargin = (int) (viewSatVal.getLeft() + x - Math.floor((double) viewTarget.getMeasuredWidth() / 2) - viewContainer.getPaddingLeft());
        layoutParams.topMargin = (int) (viewSatVal.getTop() + y - Math.floor((double) viewTarget.getMeasuredHeight() / 2) - viewContainer.getPaddingTop());
    ...
    protected void moveAlphaCursor() {
        ...
        layoutParams.leftMargin = (int) (this.viewAlphaCheckered.getLeft() - Math.floor((double) this.viewAlphaCursor.getMeasuredWidth() / 2) - this.viewContainer.getPaddingLeft());
        layoutParams.topMargin = (int) ((this.viewAlphaCheckered.getTop() + y) - Math.floor((double) this.viewAlphaCursor.getMeasuredHeight() / 2) - this.viewContainer.getPaddingTop());
